...
**initial payload at 15 kB** and **all scripts at 920 kB**, set just above what the build produces
...
The initial payload is the number to watch, and it has not moved — it is under 12 kB with six
